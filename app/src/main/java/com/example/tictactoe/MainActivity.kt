...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun updatePoints(){
        points1.text = "Player 1: $playe1Points"
        points2.text = "Player 2: $player2Points"
    }
    ...
    private fun init(){
        ...
        points1 = findViewById(R.id.textView1)
        points2 = findViewById(R.id.textView2)
